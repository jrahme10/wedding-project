    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-rose-100 flex flex-col relative overflow-hidden">
      ...
      <header className="py-6 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex justify-between items-center">
          <div className="text-3xl font-serif font-bold text-rose-800 flex items-center">
      ...
      <main className="flex-grow flex flex-col items-center justify-center px-4 py-12 text-center relative z-10">
        <div className="max-w-4xl">
          ...
          <h1 className="text-5xl md:text-7xl font-serif font-bold text-rose-900 mb-6">
            Sarah <span className="text-rose-500">&</span> Michael
          </h1>
          
          <p className="text-2xl md:text-3xl text-rose-700 mb-4 font-light">
            Are Getting Married
          </p>
          
          <div className="flex items-center justify-center space-x-3 text-rose-600 mb-16">
          ...
          {/* Countdown */}
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 mb-16 shadow-xl max-w-3xl mx-auto border border-rose-100">
          ...
          {/* RSVP Form */}
          <div id="rsvp" className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-xl max-w-2xl mx-auto mb-16 border border-rose-100">
            ...
            {isSubmitted ? (
              <div className="bg-green-100 border border-green-400 text-green-700 px-6 py-4 rounded-xl mb-6 text-lg">
          ...
          {/* Wedding Details */}
          <div id="details" className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-20">
          ...
          {/* Gallery Preview */}
          <div id="gallery" className="max-w-4xl mx-auto mb-16">
